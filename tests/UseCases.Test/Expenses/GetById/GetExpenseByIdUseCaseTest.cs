...
public class GetExpenseByIdUseCaseTest
{
    ...
    public async Task Success()
    {
        ...
        result.PaymentMethod.Should().Be((CashFlow_Communication.Enums.PaymentMethod)expense.PaymentMethod);
        result.Category.Should().Be((CashFlow_Communication.Enums.ExpensesCategories)expense.Category);
    }
