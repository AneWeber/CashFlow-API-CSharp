...
public class UpdateExpenseUseCaseTest
{
    ...
    public async Task Success()
    {
        ...
        expense.PaymentMethod.Should().Be((CashFlow_Domain.Enums.PaymentMethod)request.PaymentMethod);
        expense.Category.Should().Be((CashFlow_Domain.Enums.ExpensesCategories)request.Category);
    }
